...
- **Slash commands:** `/career-ops`, `/career-ops pipeline|oferta|ofertas|contacto|deep|interview-prep|pdf|training|project|tracker|apply|scan|batch|patterns|followup|update`. Defined in `.claude/skills/career-ops/SKILL.md` (shared with OpenCode and Gemini CLI mode files).
