...
Rules belong in files the harness reads automatically — `AGENTS.md`, `CODEX.md`, `modes/*.md`, `MEMORY.md`. Do not create sidecar documentation that requires manual loading. Reinforcement-without-enforcement decays.
